...
describe('ListManager', () => {
  ...
  describe('Empty List Item Handling', () => {
    it('detects empty list items', () => {
      ...
      const result = ListManager.isEmptyListItem(emptyListItem as any);
      expect(result).toBe(true);
    });
    ...
    it('detects non-empty list items', () => {
      ...
      const result = ListManager.isEmptyListItem(nonEmptyListItem as any);
      expect(result).toBe(false);
    });
    ...
    it('handles list items with only whitespace', () => {
      ...
      const result = ListManager.isEmptyListItem(whitespaceListItem as any);
      expect(result).toBe(true);
    });
    ...
    it('handles list items with only HTML whitespace', () => {
      ...
      const result = ListManager.isEmptyListItem(htmlWhitespaceItem as any);
      expect(result).toBe(true);
    });
  });
  ...
  describe('Handle Enter in List - Additional Cases', () => {
    it('handles empty list item detection with various HTML whitespace patterns', () => {
      ...
      const result1 = ListManager.isEmptyListItem(emptyWithBrSlash as any);
      ...
      const result2 = ListManager.isEmptyListItem(emptyWithBrSpace as any);
    ...
    it('handles list item that is not actually an LI element', () => {
      ...
      const result = ListManager.isEmptyListItem(notAListItem as any);
      expect(result).toBe(false);
    });

    it('handles null or undefined list item', () => {
      const result1 = ListManager.isEmptyListItem(null as any);
      expect(result1).toBe(false);

      const result2 = ListManager.isEmptyListItem(undefined as any);
    ...
    it('handles list item with undefined textContent and innerHTML', () => {
      ...
      const result = ListManager.isEmptyListItem(itemWithUndefinedContent as any);
      expect(result).toBe(true);
    });
  });
  ...
  describe('Edge Cases', () => {
    ...
    it('handles null selection gracefully', () => {
      ...
      expect(() => {
        ...
        ListManager.handleKeyInList({ key: 'Enter' } as any);
      }).not.toThrow();
    });
    ...
    it('handles mixed content types correctly', () => {
      ...
      const result = ListManager.isEmptyListItem(mixedContentItem as any);
      expect(result).toBe(false);
    });
    ...
    it('handles empty content with complex HTML', () => {
      ...
      const result = ListManager.isEmptyListItem(emptyWithComplexHTML as any);
    ...
    it('handles whitespace text with non-empty HTML', () => {
      ...
      const result = ListManager.isEmptyListItem(whitespaceTextItem as any);
    ...
    it('handles whitespace text with only br HTML', () => {
      ...
      const result = ListManager.isEmptyListItem(whitespaceWithBrItem as any);
